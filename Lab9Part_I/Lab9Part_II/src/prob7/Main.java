...
//		System.out.println(list.stream().sorted((x,y)-> Math.abs(y)- Math.abs(x)).collect(Collectors.toList()));
		list.stream().sorted(Comparator.comparingInt(i -> Math.abs((int)i))).forEach(x -> System.out.print(x+" "));
	...
	public static void ordering2(List<String> words) {
		System.out.println(words.stream()
				.sorted((o1,o2) -> reverseString(o1).compareTo(reverseString(o2))).collect(Collectors.toList()));
